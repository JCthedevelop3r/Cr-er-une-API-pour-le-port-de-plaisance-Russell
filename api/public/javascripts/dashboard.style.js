/*document
  .querySelector(".btn-form-create-user")
...
const btnUpdateCatwayState = document.querySelector(".btn-form-update-catway-state");
const btnDeleteCatway = document.querySelector(".btn-form-delete-catway");
const btnDisplayCatwayDetails = document.querySelector(".btn-form-display-catway-details");
const btnSaveReservation = document.querySelector(".btn-form-save-reservation");
const btnDeleteReservation = document.querySelector(".btn-form-delete-reservation");
const btnDisplayReservationDetails = document.querySelector(".btn-form-display-details-reservation");

const createUserForm = document.getElementById("createUserForm");
const updateUserForm = document.getElementById("updateUserForm");
const deleteUserForm = document.getElementById("deleteUserForm");
const createCatwayForm = document.getElementById("createCatwayForm");
const updateCatwayStateForm = document.getElementById("updateCatwayStateForm");
const deleteCatwayForm = document.getElementById("deleteCatwayForm");
const displayCatwayDetailsForm = document.getElementById("displayCatwayDetailsForm");
...
const displayReservationDetailsForm = document.getElementById("displayReservationDetailsForm");
